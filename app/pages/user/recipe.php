         ...
         <section aria-label="Resumo da receita">
            ...
            <div class="abstract_content-container">
               <div class="title-container">
                  ...
                  <p>por 
                     <?php
                        if((isset($recipe['source']) && ($recipe['source'] != null)))
                        {
                     ?>
                           <a class="link_tosrc" target="_blank" href="<?=$recipe['source']?>"><span class="recipeAuthor"><?=$recipe['author']?></span></a>
                     <?php
                        }
                        else
                        {
                     ?>
                        <span class="recipeAuthor"><?=$recipe['author']?></span>
                     <?php
                        }
                     ?>
                     
                     <br>publicado por <span class="recipeEditor"><?=$recipe['editor']?></span></p>
