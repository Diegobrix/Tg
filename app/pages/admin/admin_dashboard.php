   ...
   <header>
      ...
      <section class="desktop_menu">
         ...
         <div class="stats-container">
            <div class="bar">
               <?php
                  $recipesAmount = $content->defineContentType(0)!=null?sizeof($content->defineContentType(0)):0;    
                  $ingredientsAmount = $content->defineContentType(1)!=null?sizeof($content->defineContentType(1)):0;
                  $categoriesAmount = $content->defineContentType(2)!=null?sizeof($content->defineContentType(2)):0;    
                  $videosAmount = $content->defineContentType(3)!=null?sizeof($content->defineContentType(3)):0;  
